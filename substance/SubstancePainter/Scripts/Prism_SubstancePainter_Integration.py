...
class Prism_SubstancePainter_Integration(object):
    def __init__(self, core, plugin):
        ...
        if platform.system() == "Windows":
            self.examplePath = (
                self.core.getWindowsDocumentsPath() + "\\SubstancePainter\\2019"
            )
            ...
            self.examplePath = os.path.join("/home", userName, "SubstancePainter", "2019")
            ...
            self.examplePath = (
                "/Users/%s/Library/Preferences/Autodesk/SubstancePainter/2019" % userName
            )
    ...
    def getExecutable(self):
        execPath = ""
        if platform.system() == "Windows":
            defaultpath = os.path.join(self.getSubstancePainterPath(), "SubstancePainter.exe")
