...
from Prism_ZBrush_Functions import Prism_ZBrush_Functions
from Prism_ZBrush_Integration import Prism_ZBrush_Integration


class Prism_Plugin_ZBrush(
    Prism_ZBrush_Variables,
    Prism_ZBrush_externalAccess_Functions,
    Prism_ZBrush_Functions,
    ...
    def __init__(self, core):
        ...
        Prism_ZBrush_Functions.__init__(self, core, self)
