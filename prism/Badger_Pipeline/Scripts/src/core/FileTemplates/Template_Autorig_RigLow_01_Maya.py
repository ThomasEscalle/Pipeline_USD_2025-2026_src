...
class FileTemplateAutorigRigLow01Maya(FileTemplateBase):

    def __init__(self):
        super().__init__()
        self.template_name = "AutorigRigL01"
    ...
    def construct(self, parent, path, origin):
        ...
        dialog.setHelpLink("https://thomasescalle.github.io/Pipeline_USD_2025/departements/RiggingLow/#comment-creer-une-scene-dans-maya")
