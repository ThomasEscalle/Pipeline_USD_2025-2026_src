...
class FileTemplateFLOMaya(FileTemplateBase):
    ...
    def construct(self, parent, path, origin):
        ...
        ## 
        # Todo : recuperer le EditSetDress si il existe, sinon le SetDress.
        ##
        ...
        # Create a new product on the current entity named "FLO_Edit_SetD_Publish"
        product = origin.core.products.createProduct(current_entity , "FLO_Edit_SetD_Publish",location="global" )
        version = origin.core.products.ingestProductVersion(files=[], entity=current_entity,product="FLO_Edit_SetD_Publish", location="global")
        ...
        save_path_edit_setD = os.path.join(save_path_edit_setD, "FLO_Edit_SetD_Publish.usda")
        save_path_edit_setD = save_path_edit_setD.replace("\\", "/")
        ...
        script.replaceVariable("$$SHOT$$", shot_str)
        ...
        script.replaceVariable("$$IMPORT_CAMERA_FROM_RLO$$", "False")
