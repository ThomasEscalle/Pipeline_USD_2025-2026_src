...
# Set the path to the output file in the temp directory/temporary_setdress.usda
output_path = os.path.join(QStandardPaths.writableLocation(QStandardPaths.TempLocation), "temporary_setdress.usda")
...
core.products.createProduct(fnameData, "SetD_Publish", "global")

# Ingest the new version into prism
result = core.products.ingestProductVersion([output_path], fnameData,"SetD_Publish")
...
sticky_note.setPosition(hou.Vector2(3, -4))
sticky_note_text = "Cette scène sert a importer tes assets pour les assembler et former le setDress.\n"
