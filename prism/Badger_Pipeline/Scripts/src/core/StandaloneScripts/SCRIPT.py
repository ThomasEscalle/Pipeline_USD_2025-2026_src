...
assetName = "TEST2"   # <-- Name of the asset, string to be set by the user
...
importReferencePaths = "['E:/3D/Projects/06_Ouyang/03_Production/01_Assets/Chars/TEST2/Export/ModL_Publish/master/TEST2_ModL_Publish_master.abc', 'E:/3D/Projects/06_Ouyang/03_Production/01_Assets/Items/Pavot_Flower/Export/ModH_Publish_var002/master/Pavot_Flower_ModH_Publish_var002_master.abc', 'E:/3D/Projects/06_Ouyang/03_Production/01_Assets/Items/Pavot_Flower/Export/ModH_Publish_var002/master/Pavot_Flower_ModH_Publish_var002_master.abc']" # <-- Path to the reference file if importReference is "True". It is a an array of paths contained into a string. Use eval() before to use it.
...
numberOfGroups = "06" # <-- Number of output groups
