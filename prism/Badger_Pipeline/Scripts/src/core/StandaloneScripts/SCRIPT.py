...
assetName = "Poubelle"             # <-- Name of the asset, string to be set by the user
...
creationMethod = "Number of variant first"   # <-- Method to use for creating, can be "Modeling high first" or "Number of variant first"
numberOfGroups = "01"  # <-- Number of output groups. Only used if creationMethod is "Number of variant first"

referencePath = "['E:/3D/Projects/06_Ouyang/03_Production/01_Assets/Items/Poubelle/Export/ModH_Publish/master/Poubelle_ModH_Publish_master.usd', 'E:/3D/Projects/06_Ouyang/03_Production/01_Assets/Items/Poubelle/Export/ModH_Publish_var001/master/Poubelle_ModH_Publish_var001_master.usdc', 'E:/3D/Projects/06_Ouyang/03_Production/01_Assets/Items/Poubelle/Export/ModH_Publish_var002/master/Poubelle_ModH_Publish_var002_master.usdc', 'E:/3D/Projects/06_Ouyang/03_Production/01_Assets/Items/Poubelle/Export/ModH_Publish_var003/master/Poubelle_ModH_Publish_var003_master.usdc']"       # <-- Path to the reference file if importReference is "True". It is a string.
