...
assetName = "Nathan"             # <-- Name of the asset, string to be set by the user
assetType = "Chars"             # <-- Type of the asset, string to be set by the user, e.g. "character", "prop", etc.
taskName = "Surf_02"               # <-- Name of the task, string to be set by the user, e.g. "Modeling", "Rigging_v012", etc.
...
referencePath = "['E:/3D/Projects/06_Ouyang/03_Production/01_Assets/Chars/Nathan/Export/ModH_Publish_var001/master/Nathan_ModH_Publish_var001_master.usd', 'E:/3D/Projects/06_Ouyang/03_Production/01_Assets/Chars/Nathan/Export/ModH_Publish_var002/master/Nathan_ModH_Publish_var002_master.usd']"       # <-- Path to the reference file if importReference is "True". It is a string.
